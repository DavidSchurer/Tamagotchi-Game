            ...
            case 'B':
                switch (selectedAction) {
                    ...
                    case 'heal':
                        ...
                        break;
                    case 'duck':
                        setGif('https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExank1bTlpY2Ewb2MwdTJ4dzRlZm5oc29kenhpMWpyZnRudGRpZzdxbiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/XkxfezUB7Rj4k/giphy.gif')
                        displayGif();
                        break;                        
                    case 'status':
                        setShowModal(true);
